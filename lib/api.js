...
/** Toutes les idées visibles de tous les défis (page « Les équipes »). */
export const getIdeas = () => call("/ideas");
...
/** Quitter son équipe. `successorId` requis seulement pour le coordinateur. */
export const leaveIdea = (id, successorId) => call("/ideas/" + id + "/leave", { method: "POST", body: { successorId } });
/** Supprimer son idée (coordinateur). Archive, ne détruit pas. */
export const deleteIdea = (id) => call("/ideas/" + id + "/delete", { method: "POST" });
...
export const invite = (ideaId, participantId, note) =>
  call("/ideas/" + ideaId + "/invite", { method: "POST", body: { participantId, note } });
